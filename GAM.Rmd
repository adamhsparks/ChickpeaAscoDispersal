...
Looking at `mod11`, `mws` is not significant as a smoothed term, and we'd
...
plot(mod11, main = "s(Distance) + s(Windspeed) + s(Precipitation), family = tw()")
plot(mod11, main = "s(Distance) + s(Precipitation) + Windspeed, family = tw()")
```
