...
pacman::p_load(tidyverse, broom, skimr, devtools, ggpubr, mgcv, extrafont, mgcViz)
...
ggsave("figures/FigGAM.png")
ggsave("figures/FigGAM.eps")
embed_fonts("figures/FigGAM.eps", outfile = "figures/FigGAM.eps",
            options = "-dEPSCrop")
print(
