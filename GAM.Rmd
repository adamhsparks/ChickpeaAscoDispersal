...
### mod11.` - s(Distance, bs = "ts") + s(Windspeed, bs = "ts") + s(Precipitation, bs = "ts"), family = tw()
...
```{r vis-mods}
par(mfrow = c(2, 2))
plot(mod1, main = "s(Distance)", pages = 1)
plot(mod2, main = "s(Distance) + Precipitation", pages = 1)
plot(mod3, main = "s(Distance) + Windspeed", pages = 1)
plot(mod4, main = "s(Distance) + Windspeed + Precipitation", pages = 1)
plot(mod5, main = "s(Distance + Windspeed) + Precipitation", pages = 1)
plot(mod6, main = "s(Distance) + s(Windspeed) + Precipitation", pages = 1)
plot(mod7, main = "s(Distance) + s(Windspeed)", pages = 1)
plot(mod8, main = "s(Distance) + s(Windspeed) + s(Precipitation)", pages = 1)
plot(mod9, main = "s(Distance) + s(Precipitation)", pages = 1)
plot(mod10, main = "s(Distance) + s(Precipitation) + Windspeed", pages = 1)
plot(mod11.0, main = "s(Distance) + s(Windspeed) + s(Precipitation), family = tw()", pages = 1)
plot(mod11.1, main = "s(Distance, bs = 'ts') + s(Windspeed, bs = 'ts')\n+ s(Precipitation, bs = 'ts'), family = tw()", pages = 1)
plot(mod12, main = "s(Distance) + s(Precipitation) + Windspeed, family = tw()", pages = 1)
```
