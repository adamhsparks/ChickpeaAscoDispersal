...
pacman::p_load(tidyverse, lubridate, skimr, ggpubr, kableExtra, here)
...
## Visualise the Combination of Wind and Rain
...
ggplot(data = weather, aes(x = Time, y = rainfall)) +
   geom_line(aes(x = Time, y = wind_speed)) +
   ...
   facet_wrap(Location ~ Rep, scales = "free")
```
