...
Curyo_w <-
   ...
   rename(`Wind Speed - average (m/s)` = `Wind Speed - average (km/h)`) %>% 
...
To do this, first `filter()`, then use `case_when()` to match the dates and times with the event data frame to 
