...
vignette: >
  %\VignetteIndexEntry{01_lesion_data_import}
...
dat <-
   read_csv(here("inst/data", "lesion_counts.csv")) %>%
...
# rename the site names to align with the cleaned weather data
...
write_csv(x = dat, path = here("inst/cache", "/summarised_lesion_data.csv"))
