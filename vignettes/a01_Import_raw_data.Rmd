...
Lastly the mean lesions counted per plant within the pot, `mean_pot_count` is calculated for each of the transects at each distance, 0, 10, 25, 50 and 75 meters from the plots.
