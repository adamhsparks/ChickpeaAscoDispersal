...
This vignette demonstates the methods of preliminary data analysis. The aims of this document was to explore the pattern of data and understand which factors would affect the distance spores travel during a 'spread event'.  
...
From this data we hope to obtain the following.  
  ...
  - What factors influence conidia dispersal distance.  
  
In this experiment there are a number of factors which may influence the spore spread. These include:  
  * Experimental location (site).  
  * The time at which a spread event occured (SpEv).  
    - The factor SpEv would be nested within site.  
    - This factor may describe variation in the data that varies between SpEv, such as weather and climate variables.  
...
Therefore our aim of this analysis will soley focus on the factors which influnce the distance of dispersal.  
