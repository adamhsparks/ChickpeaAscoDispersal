...
vignette: >
  ...
  %\VignetteDepends{stationaRy}
  %\VignetteDepends{bomrang}
  %\VignetteDepends{clifro}
  %\VignetteDepends{leaflet}
...
However, conidia were recorded travelling up to 75&nbsp;metres from the infested stubble north, against the wind during the spread event.
